...
export type ClientToServerEvents = {
  ...
  'rtc:offer': (payload: { to: number; callId: string; groupId?: number; sdp: RTCSessionDescription | null }) => void;
...
export type ServerToClientEvents = {
  ...
  'call:invite': (payload: { callId: string; withVideo: boolean; from: number; fromUsername: string; fromDisplayName?: string; fromAvatarPath?: string | null }) => void;
  ...
  'rtc:offer': (payload: { from: number; callId: string; groupId?: number; sdp: RTCSessionDescriptionInit }) => void;
